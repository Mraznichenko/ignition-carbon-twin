    ...
    <main>
      <section className="mx-auto max-w-6xl px-4 pb-20 pt-10 md:pt-16">
        <div className="grid items-stretch gap-8 rounded-[2rem] border border-border bg-card/80 p-6 shadow-sm md:grid-cols-[1.1fr_0.9fr] md:p-10">
          <div className="flex h-full flex-col">
            ...
            <div className="py-8 md:py-10">
              ...
              <p className="mt-5 max-w-2xl text-pretty text-lg leading-8 text-muted-foreground">
                It learns your food, shopping, and travel habits, then shows the changes that matter
                most for your real life.
              </p>
            </div>
          ...
          <div className="rounded-[1.75rem] bg-gradient-to-br from-[var(--primary-soft)] via-card to-secondary p-4 text-center md:p-5">
            <HeroTwinPreview />
            <div className="mt-4 rounded-2xl bg-card/90 p-4 text-left shadow-sm">
...
function HeroTwinPreview() {
  return (
    <div className="relative mx-auto grid h-48 w-full max-w-80 place-items-end overflow-hidden rounded-[2rem] bg-gradient-to-b from-emerald-50/10 via-emerald-50/45 to-emerald-100/85 md:h-52">
      <div className="absolute inset-x-6 bottom-7 h-16 rounded-[50%] bg-emerald-200/45 blur-xl" />
      <div className="relative z-10 mb-3 translate-y-4 scale-110">
        <CarbonAvatar score="A" size="lg" />
      </div>
      <div className="absolute inset-x-0 bottom-0 z-20 px-4 pb-2">
        <svg viewBox="0 0 180 62" className="h-16 w-full" aria-hidden="true">
